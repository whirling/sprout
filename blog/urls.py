...
urlpatterns = [
    ...
    url(r'^self_help/$', views.self_help, name='self_help'),
    url(r'^therapy/$', views.therapy, name='therapy'),
    url(r'^chat/$', views.chat, name='chat'),
    url(r'^hotline/$', views.hotline, name='hotline'),
    ...
    url(r'^resource/(?P<pk>\d+)/$', views.resource_detail, name='resource_detail'),
    url(r'^homepage/suicidepreventionlifeline.org//$', views.redirect_to_hotline, name='redirect_to_hotline'),
